                ...
                children: [
                   Row(
                    ...
                    children: [
                      ...
                      Text('Now Playing',style: GoogleFonts.lato(color: Colors.white,fontSize: 30)),
              ...
              child: Column(
                children: [
                   Row(
                    ...
                    children: [
                      const SizedBox(width: 20,),
                      Text('Popular Movies',style: GoogleFonts.lato(color: Colors.white,fontSize: 30)),
              ...
              child: Column(
                children: [
                   Row(
                    ...
                    children: [
                      const SizedBox(width: 20,),
                      Text('Top Rated Movies',style: GoogleFonts.lato(color: Colors.white,fontSize: 30)),
